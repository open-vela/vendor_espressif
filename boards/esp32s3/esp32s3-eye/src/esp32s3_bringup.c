/****************************************************************************
 * vendor/espressif/boards/esp32s3/esp32s3-eye/src/esp32s3_bringup.c
 *
...
int esp32s3_bringup(void)
{
  ...
  if (qma_i2c == NULL)
  ...
  else
    {
      ...
      if (ret < 0)
        {
          syslog(LOG_ERR, "ERROR: qma7981_register failed: %d\n", ret);
        }
    }
#endif
