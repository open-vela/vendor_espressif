...
static const struct ov2640_regval_s g_ov2640_reset[] = {
    {0xff, 0x01}, {0x12, 0x80}, /* COM7 soft reset */
};
...
static const struct ov2640_regval_s g_ov2640_to_cif[] = {
    ...
    {0x4f, 0xca},               /* BD50 */
    {0x50, 0xa8},               /* BD60 */
    {0x5a, 0x23}, {0x6d, 0x00}, {0x3d, 0x38}, {0x39, 0x92}, {0x35, 0xda},
    {0x22, 0x1a}, {0x37, 0xc3}, {0x23, 0x00}, {0x34, 0xc0}, {0x06, 0x88},
    {0x07, 0xc0}, {0x0d, 0x87}, {0x0e, 0x41}, {0x4c, 0x00}, {0xff, 0x00},
...
static const struct ov2640_regval_s g_ov2640_dsp_en[] = {
    {0xff, 0x00}, {0x05, 0x00}, /* R_BYPASS: DSP_EN */
};

/* Phase 7: RGB565 output */

static const struct ov2640_regval_s g_ov2640_rgb565[] = {
    {0xff, 0x00}, {0xe0, 0x04}, /* RESET: DVP */
    {0xda, 0x09},               /* IMAGE_MODE: RGB565 + byte swap */
    {0xd7, 0x03}, {0xe1, 0x77}, {0xe0, 0x00}, /* RESET: enable all */
};
...
static int ov2640_write_reg(FAR struct i2c_master_s *i2c, uint8_t reg,
                            uint8_t val);
...
static FAR const char *ov2640_get_driver_name(FAR struct imgsensor_s *sensor);
static int ov2640_validate(FAR struct imgsensor_s *sensor,
                           imgsensor_stream_type_t type, uint8_t nr_datafmts,
...
static bool ov2640_is_available(FAR struct imgsensor_s *sensor) { return true; }
...
static int ov2640_uninit(FAR struct imgsensor_s *sensor) { return OK; }
